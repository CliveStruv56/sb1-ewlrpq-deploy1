...
import { format, addDays, setHours, setMinutes, isAfter, addMinutes, startOfDay } from 'date-fns';
...
export const TimeSelection: React.FC<TimeSelectionProps> = ({ onConfirm }) => {
  ...
  const [dateAvailability, setDateAvailability] = React.useState<Map<string, boolean>>(new Map());
    ...
    const checkDatesAvailability = async () => {
      ...
      for (const date of dates) {
        ...
        try {
          ...
          // A date is available if it has at least one available time slot
